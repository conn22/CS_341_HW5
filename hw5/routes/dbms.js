...
var host = "35.185.223.106";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "root";         //username (change to match your db)
var password = "CwtefyHEpt2nHyK8";  //password (change to match your db, yes this is very poor practice)
